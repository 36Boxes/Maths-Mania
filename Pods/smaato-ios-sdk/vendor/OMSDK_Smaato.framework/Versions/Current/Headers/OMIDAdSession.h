 ...
 */
@property (nonatomic, readonly) OMIDSmaatoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDSmaatoAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDSmaatoAdSessionContext *)context
 ...
 */
- (void)logErrorWithType:(OMIDErrorType)errorType message:(NSString *)message NS_SWIFT_NAME(logError(withType:message:));
